            ...
            <div className='chatme'>
              <div className="chat-details">
                <div className="left-name">
                  ...
                  <p className="name-det">{toTalk.userName || toTalk.groupName}</p>
                </div>
                      ...
                      return (
                        (payload.senderId === userName) ?
                          ...
                          <div id='member-msg' className="message-chat" key={index}>
                            ...
                            <p className="member" style={{ backgroundColor: '#0f3d7c' }} >
                              <span style={{color:"#C0C0C0"}} className="user-name">{payload.senderId}</span>
                              <span style={{color:"white"}} className="member-chat">{payload.content}</span></p>
                          </div>
                      )
                    })
